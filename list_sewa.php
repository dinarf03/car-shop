      ...
      <tbody>
        <?php foreach ($_SESSION["session_sewa"] as $hasil): ?>
          <tr>
            ...
            <td><input type="number" name="jumlah<?php echo $hasil["id_mobil"];?>"  min="1" required></td>
            <td><?php echo number_format($hasil["biaya_sewa_per_hari"]); ?>/hari</td>
