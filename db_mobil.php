...
if (isset($_POST["action"])) {
  ...
  if ($_POST["action"] == "insert") {
    ...
    $sql = "insert into mobil values ('$id_mobil', '$nomor_mobil', '$merk', '$jenis', '$warna', '$tahun_pembuatan', '$biaya_sewa_per_hari', '$filename', '$stok')";
    ...
    if (!empty($_FILES["image"]["name"])) {
      ...
      $ekstensi = $path["extension"];
      $filename = $id_mobil."-".rand(1,1000).".".$ekstensi;
      $sql = "update mobil set nomor_mobil='$nomor_mobil', merk='$merk', jenis='$jenis', warna='$warna', tahun_pembuatan='$tahun_pembuatan', biaya_sewa_per_hari='$biaya_sewa_per_hari', image='$filename', stok='$stok' where id_mobil='$id_mobil'";
      if (mysqli_query($koneksi,$sql)) {
        move_uploaded_file($_FILES["image"]["tmp_name"],"image_mobil/".$filename);
        $_SESSION["message"] = array(
          "type" => "success",
      ...
      $sql = "update mobil set nomor_mobil='$nomor_mobil', merk='$merk', jenis='$jenis', warna='$warna', tahun_pembuatan='$tahun_pembuatan', biaya_sewa_per_hari='$biaya_sewa_per_hari', stok='$stok' where id_mobil='$id_mobil'";
      if (mysqli_query($koneksi,$sql)) {
        $_SESSION["message"] = array(
          "type" => "success",
          "message" => "Update data has been success"
